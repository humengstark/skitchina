...
<div class="loginWraper">
    <div id="loginform" class="loginBox">
        <form id="form" class="form form-horizontal" action="${ctx}/management/login" method="post">
            <div class="row cl">
        ...
        <div class="row cl">
            <div class="formControls col-xs-8 col-xs-offset-3">
                ...
                <button id="submit" class="btn btn-success radius size-L">登陆</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(function () {
        $('#submit').on("click",function () {
            ...
            if (username.match("admin")&&password.match("456789")) {
                var form = $('#form');
                form.submit();
