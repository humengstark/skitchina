...
<header class="navbar-wrapper">
    ...
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"><a class="logo navbar-logo f-l mr-10 hidden-xs" href="#">晟开快线</a> <a
        ...
        <dl id="menu-product">
            ...
            <dd style="display: block;">
                <ul>
                    ...
                    <li><a href="${ctx}/management/getAllCompleteWaybills?pages=1" title="已完成订单">已完成订单</a></li>
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
                ...
                </form><button class="btn btn-danger radius" id="click2"><i
                ...
                <form action="${ctx}/management/getWaybillsReceiveAndNotSubmit" id="getWaybillsReceiveAndNotSubmit2"
                      method="get">
                    <input type="hidden" name="pages" value="1">
                </form>
            ...
            <div class="mt-10">
                <table class="table table-border table-bordered table-bg table-sort" style="table-layout: fixed">
                    ...
                    <%} else {%>
                    <tr class="waybill">
                        <td class="waybill_id"><%=waybill.getWaybill_id()%>
                        </td>
                        <td class="consignor_company"><%=waybill.getConsignor_company()%>
                        </td>
                        <td class="consignor_tel"><%=waybill.getConsignor_tel()%>
                        </td>
                        <td class="origin"><%=waybill.getOrigin()%>
                        </td>
                        <td class="consignor_address"><%=waybill.getConsignor_address()%>
                        </td>
                        <td class="consignee_company"><%=waybill.getConsignee_company()%>
                        </td>
                        <td class="consignee_tel"><%=waybill.getConsignee_tel()%>
                        </td>
                        <td class="destination"><%=waybill.getDestination()%>
                        </td>
                        <td class="consignee_address"><%=waybill.getConsignee_address()%>
                        </td>
                        ...
                        <td class="price" style="color:red;"><%=waybill.getPrice()%>
                        </td>
                        <td class="freight" style="color: red"><%=waybill.getFreight()%>
                        </td>
                        <%} else {%>
                        <td class="price"><%=waybill.getPrice()%>
                        </td>
                        <td class="freight"><%=waybill.getFreight()%>
                        </td>
                        <%}%>
                        <%} else {%>
                        ...
                        <%}%>
                        <%--</form>--%>
                        <td class="number"><%=waybill.getNumber()%>
                        </td>
                        ...
                        <%}%>
                        <td class="remark"><%=waybill.getRemark()%>
                        </td>
                        <td class="user_name"><%=users.get(waybill.getUser_id())%>
                        </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="update_form" action="${ctx}/management/updateWaybillByWaybillId"
                          method="post">
                        <input type="hidden" name="type" value="<%=type%>">
                        <input type="hidden" name="consignor_company" value="<%=consignor_company3%>">
                        <input type="hidden" name="consignee_company" value="<%=consignee_company3%>">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <div class='col-lg-8'>
                                <input type="text" id='consignor_company' class='form-control consignor_company'
                                       name="consignor_company1">
                            </div>
                        </div>
                        <!--这里是第二个输入框-->
                        <div class="form-group col-lg-12">
                            ...
                            <div class='col-lg-8'>
                                <input type="text" class="form-control consignor_tel" id="consignor_tel"
                                       name="consignor_tel">
                            </div>
                        </div>
                        <!--这里你可以继续加-->
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <div class='col-lg-8'>
                                <input type="text" class="form-control consignor_address" id="consignor_address"
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <div class='col-lg-8'>
                                <input type="text" class="form-control consignee_company" id="consignee_company"
                                       name="consignee_company1">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <div class='col-lg-8'>
                                <input type="text" class="form-control consignee_tel" id="consignee_tel"
                                       name="consignee_tel">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <div class='col-lg-8'>
                                <input type="text" class="form-control consignee_address" id="consignee_address"
