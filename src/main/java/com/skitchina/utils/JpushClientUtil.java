...
public class JpushClientUtil {
    ...
    private final static String appKey = "b6604d29413afd77f376664a";

    private final static String masterSecret = "202af1993a344fcf9c579543";

    private static JPushClient jPushClient = new JPushClient(masterSecret,appKey);

    public static int sendToTag(String tag) throws APIConnectionException, APIRequestException {
